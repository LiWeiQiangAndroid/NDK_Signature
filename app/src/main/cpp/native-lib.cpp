...
static char *PACKAGE_NAME = "com.liwq.ndk_signature";
...
Java_com_liwq_ndk_1signature_SignatureUtils_signatureParams(JNIEnv *env, jclass type,
                                                         jstring params_);

JNIEXPORT void JNICALL
Java_com_liwq_ndk_1signature_SignatureUtils_signatureVerify(JNIEnv *env, jclass type,
                                                         jobject context);
}
